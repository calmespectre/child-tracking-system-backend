...
class BeneficiaryViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.action == "list":
            ...
            gender_filter = self.request.query_params.get(
                "gender"
            )
            ...
            village_filter = self.request.query_params.get(
                "village"
            )
            ...
            document_filter = self.request.query_params.get(
                "documents"
            )
