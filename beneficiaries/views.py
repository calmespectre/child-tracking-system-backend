...
class UserSessionListView(APIView):
    ...
    def get(self, request):
        ...
        sessions = user_obj.sessions.all().order_by("-timestamp")
    ...
    def get(self, request):
        ...
        for log in logs:
            ...
            activities.append(
                {
                    "id": log.id,
                    "beneficiary_id": beneficiary.child_number,
                    "beneficiary_name": (
...
class DashboardSummaryView(APIView):
    ...
    def get(self, request):
        ...
        if user.role == "employee":
            ...
            benefits = SupportLog.objects.filter(
            ...
            for item in benefits_by_type:
                item["percentage"] = round(
                    (item["count"] / total_benefits) * 100,
                    1,
                ) if total_benefits else 0
                ...
                formatted_activities.append(
                    {
                        ...
                        "beneficiary_id": activity[
                            "beneficiary__child_number"
                        ],
                        "beneficiary_name": (
                            activity["beneficiary__short_name"]
                            or activity["beneficiary__last_name"]
                        ),
                    }
                )
        ...
        employees = (
            ...
            .annotate(
                ...
                benefits_count=Count(
                    "beneficiaries__support_logs",
                    distinct=True,
                ),
            )
            .order_by("-beneficiary_count", "email")
        )
            ...
            employee_data.append(
                {
                    ...
                    "beneficiary_count": employee.beneficiary_count,
                    "benefits_count": employee.benefits_count,
