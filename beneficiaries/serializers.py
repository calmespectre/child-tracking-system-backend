...
class BeneficiaryListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Beneficiary
        fields = [
            "id", "communityNumber", "lastName", "childNumber",
            "participantCaseNumber", "gender", "shortName", "birthdate",
            "sponsorshipStatus", "enrollmentDate", "narrativeDate",
            "photoDate", "age", "village", "createdAt", "updatedAt",
            "createdBy"
        ]
...
class BeneficiaryDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "sponsorshipStatus", "enrollmentDate", "narrativeDate",
            "photoDate", "age", "village", "createdAt", "updatedAt",
            "createdBy", "notes", "documents", "supportLog"
        ]
